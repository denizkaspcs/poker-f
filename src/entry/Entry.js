...
function Entry() {
    ...
    const get_deck = async () => {
        axios.get(`http://abiler-poker-back.herokuapp.com/get_deck?room_id=${roomId}`).then((response) => {
    ...
    const on_submit = async () => {
        if (create) {
            await axios.post('http://abiler-poker-back.herokuapp.com/createRoom', {
                id: roomId,
                name: playerName,
                money: money,
            ...
            await axios.post('http://abiler-poker-back.herokuapp.com/enterRoom', {
                id: roomId,
                name: playerName
            }).then((results) => {
                let url = "/room/" + roomId;
